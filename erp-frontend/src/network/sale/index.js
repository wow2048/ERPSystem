...
export const createSaleStrategy = config => request._post(testAPI.SALE_STRATEGY_CREATE, config)
export const getSaleStrategy = config => request._get(testAPI.SALE_STRATEGY_GET, config)