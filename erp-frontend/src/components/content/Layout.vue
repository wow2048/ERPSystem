...
<!--          </el-menu-item>-->
        ...
        <el-submenu index="3"
          ...
          <el-menu-item
            :index="PATH.MAX_AMOUNT_CUSTOMER.path"
            v-if="permit(PATH.MAX_AMOUNT_CUSTOMER.requiresAuth)"
          >
            <i class="el-icon-user"></i>
            <span slot="title">查询消费总金额最大的客户</span>
          </el-menu-item>

          <el-menu-item
            :index="PATH.SALE_STRATEGY.path"
            v-if="permit(PATH.SALE_STRATEGY.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">制定销售策略</span>
          </el-menu-item>
        ...
        <el-submenu index="5"
          ...
          <el-menu-item
              :index="PATH.STAFF_CHECKIN.path"
              v-if="permit(PATH.STAFF_CHECKIN.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
              :index="PATH.STAFF_SALARYSTRATEGY.path"
              v-if="permit(PATH.STAFF_SALARYSTRATEGY.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">薪酬规则</span>
          </el-menu-item>
       ...
       <!--财务管理-->
        <el-submenu index="6"
          v-if="permit(PATH.FINANCE_MANAGEMENT.requiresAuth)">
          <template slot="title">
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
            :index="PATH.SALE_DETAIL_CHECK.path"
            v-if="permit(PATH.SALE_DETAIL_CHECK.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
            :index="PATH.BUSINESS_PROGRESS_CHECK.path"
            v-if="permit(PATH.BUSINESS_PROGRESS_CHECK.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
            :index="PATH.BUSINESS_CONDITION_CHECK.path"
            v-if="permit(PATH.BUSINESS_CONDITION_CHECK.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">查看经营情况表</span>
                    ...
                    <el-menu-item
            :index="PATH.PAYMENT_SHEET_VIEW.path"
            v-if="permit(PATH.PAYMENT_SHEET_VIEW.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
            :index="PATH.RECEIPT_SHEET_VIEW.path"
            v-if="permit(PATH.RECEIPT_SHEET_VIEW.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
            :index="PATH.SALARY_SHEET_VIEW.path"
            v-if="permit(PATH.SALARY_SHEET_VIEW.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
